  ...
  <body class="bg-gray-100">
    ...
    <div class="flex items-center justify-center min-h-screen pb-10">
      <div class="w-full max-w-2xl p-8 bg-white rounded-lg shadow-lg">
        ...
        <form action="<?php echo e(route('editBikeUpdate')); ?>" method="POST" class="space-y-6" enctype='multipart/form-data'>
            <?php echo csrf_field(); ?>
          ...
          <div>
            ...
            <input
              ...
              id="brand"
              name="brand"
              value="<?php echo e($storage->brand); ?>"
              required
              class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              id="model"
              name="model"
              value="<?php echo e($storage->model); ?>"
              required
              class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              id="price"
              name="price"
              value="<?php echo e($storage->price); ?>"
              required
              class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
          </div>
          ...
          <div>
            ...
            >
            <textarea
              id="descripdescriptiontion"
              name="description"
              
              rows="4"
              class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ><?php echo e($storage->description); ?></textarea>
          </div>
            ...
            <div class="mt-1 flex items-center space-x-6">
                <div class="flex items-center">
                    <input
                        ...
                        name="status"
                        value="active"
                        <?php echo e($storage->status == 'active' ? 'checked' : ''); ?>
                ...
                <div class="flex items-center">
                    <input
                        ...
                        name="status"
                        value="inactive"
                        <?php echo e($storage->status == 'inactive' ? 'checked' : ''); ?>
...
<?php /**PATH C:\Users\AC\Desktop\t1\app\resources\views/edit.blade.php ENDPATH**/ ?>
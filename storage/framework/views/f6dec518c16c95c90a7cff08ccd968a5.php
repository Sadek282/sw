  ...
  <body class="bg-gray-100">
    ...
    <div class="flex items-center justify-center min-h-screen pb-10">
      <div class="w-full max-w-2xl p-8 bg-white rounded-lg shadow-lg">
        ...
        <form action="<?php echo e(route('submit')); ?>" method="POST" class="space-y-6" enctype='multipart/form-data'>
            <?php echo csrf_field(); ?>
          <div>
...
<?php /**PATH C:\Users\AC\Desktop\t1\app\resources\views/bike.blade.php ENDPATH**/ ?>